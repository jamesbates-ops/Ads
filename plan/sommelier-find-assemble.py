...
f1=F(48); d.text((40,92),"£480",font=f1,fill=(200,200,200,255)); w1=d.textlength("£480",font=f1); d.line((36,120,44+w1,120),fill=(230,80,80,255),width=6)
d.text((52+w1,88),"→",font=F(52),fill=GOLD); d.text((112+w1,66),"£125",font=F(84),fill=GOLD)
im.save("offer.png")
